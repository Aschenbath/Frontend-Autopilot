...
export const EVENT_COPY = { 'cmd:start': '正在执行本地命令', 'cmd:done': '本地命令执行完成', 'preview:start': '正在启动本地预览服务', 'preview:ready': '本地预览已就绪', screenshot: '已截取页面截图', scenario: '交互场景已执行', 'repair:exhausted': '修复轮次已用尽，判定失败', 'model:retry': '模型调用重试', 'plan:start': '正在理解需求与参考图', 'plan:done': '产品规格已经生成', 'design:done': '设计规格已经批准', 'build:start': '正在生成产品初稿', 'build:done': '产品文件生成完成', 'quality:audit': '正在执行 UI 质量验收', 'visual:compare': '正在比较视觉一致性', 'polish:start': '正在抛光成品候选', 'polish:applied': '成品候选已应用', 'polish:failed': '成品候选未通过复验', 'fix:start': '正在根据失败证据修复', 'fix:applied': '修复文件已经应用', review: '机械验收完成', 'report:written': '交付报告已经生成', fatal: '运行发生错误' };
